export default {
  ...
  knowledgebase: {
    ...
    uploadHint: '支持 .md、.txt、.pdf、.docx、.pptx 格式，单文件不超过 20MB，总大小不超过 200MB',
    selectedFiles: '已选择文件',
    uploadButton: '开始上传',
    uploadProgress: '上传进度',
    uploadComplete: '上传完成',
    uploadFinishedWithErrors: '上传完成，但有文件失败',
    success: '成功',
    failed: '失败',
    noFiles: '请先选择文件',
    uploadError: '上传失败',
    uploadInterrupted: '上传中断，请重试',
    fileTooLarge: '文件「{filename}」超过大小限制，单文件最大 {maxSize}',
    totalSizeTooLarge: '所选文件总大小超过限制，单次最多 {maxSize}',
    requestTooLarge: '上传请求过大，请减少文件数量或文件大小后重试',
    starting: '开始处理...',
    processing: '处理中',
    completed: '已完成',
    documentList: '文档列表',
