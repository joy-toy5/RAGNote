export default {
  ...
  knowledgebase: {
    ...
    uploadHint: 'Supports .md, .txt, .pdf, .docx, .pptx. Max 20MB per file, 200MB per upload',
    selectedFiles: 'Selected Files',
    uploadButton: 'Upload',
    uploadProgress: 'Upload Progress',
    uploadComplete: 'Upload Complete',
    uploadFinishedWithErrors: 'Upload complete with failed files',
    success: 'Success',
    failed: 'Failed',
    noFiles: 'Please select files first',
    uploadError: 'Upload failed',
    uploadInterrupted: 'Upload interrupted, please try again',
    fileTooLarge: 'File "{filename}" exceeds the limit. Max size per file is {maxSize}',
    totalSizeTooLarge: 'Selected files exceed the total upload limit. Max size is {maxSize}',
    requestTooLarge: 'Upload request is too large. Please reduce file count or file size and try again',
    starting: 'Starting...',
