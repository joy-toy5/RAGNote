  ...
  <div class="settings-container">
    ...
    >
      ...
      <div class="theme-list">
        ...
        >
          <div class="theme-preview" :style="{ backgroundColor: theme.bgColor || '#F7EEDD' }">
            <div class="theme-preview-primary" :style="{ backgroundColor: theme.primaryColor }"></div>
            <div class="theme-preview-text" :style="{ backgroundColor: '#000000' }"></div>
            <div class="theme-preview-text2" :style="{ backgroundColor: '#5C5C5C' }"></div>
          </div>
